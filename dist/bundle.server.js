...
exports.default = {
  serverRequest: function serverRequest(store) {
    return store.dispatch('getAnimalInfo');
  },
  mounted: function mounted() {
    if (this.animalInfo == '') {
      this.$store.dispatch('getAnimalInfo');
    }
  },

  computed: {
    animalInfo: function animalInfo() {
      return this.$store.state.animalInfo;
    }
  }
};
...
function createStore() {
  var store = new _vuex2.default.Store({
    ...
    actions: {
      ...
      getAnimalInfo: function getAnimalInfo(_ref2) {
        var commit = _ref2.commit;

        return _axios2.default.get('http://localhost:8080/api/getAnimalInfo').then(function (res) {
    ...
    mutations: {
      ...
      setAnimalInfo: function setAnimalInfo(state, res) {
...
Component.options.__file = "/Users/dingxiang347/workspace/vuewebpack/ssr and prerender/vue-ssr/src/App.vue"
...
Component.options.__file = "/Users/dingxiang347/workspace/vuewebpack/ssr and prerender/vue-ssr/src/routes/animal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "/Users/dingxiang347/workspace/vuewebpack/ssr and prerender/vue-ssr/src/routes/home.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "/Users/dingxiang347/workspace/vuewebpack/ssr and prerender/vue-ssr/src/routes/people.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
